...
public class MiniClient extends Thread{
    ...
    private void communicate(PrintWriter writer, BufferedReader reader) throws IOException, ClassNotFoundException, NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    private byte[] decypher(byte[] coded_texto, String algoritmo, Key key) {
        byte[] texto;
        try{  
    ...
    private byte[] cypher(byte[] toBeCyphered, String algorithm, Key key) {
        byte[] llaveCifrada;
        try{
